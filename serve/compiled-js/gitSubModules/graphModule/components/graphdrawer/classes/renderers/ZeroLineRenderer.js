...
export class ZeroLineRenderer {
    drawIfInRange(graphAndCanvasData) {
        ...
        if (graphProperties.min < MathematicalConstants.Zero && graphProperties.max > mathematicalZero) {
            ...
            ctx.moveTo(canvasProperties.marginWidth, yCoordinate);
            ctx.lineTo(canvasProperties.marginWidth + canvasProperties.renderAreaWidth, yCoordinate);
            ctx.stroke();
        }
    }
}
//# sourceMappingURL=ZeroLineRenderer.js.map