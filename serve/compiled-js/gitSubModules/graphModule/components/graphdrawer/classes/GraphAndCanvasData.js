...
export class GraphAndCanvasData {
    constructor(canvasProperties, graphProperties, dataset, maxNumberOfLabelsOnXAxis, numberOfLabelsOnYAxis, fontSettings, colorSettings, ctx, axisTitles, xAxisLabels) {
        this.verifyParameterTypes(canvasProperties, graphProperties, dataset, maxNumberOfLabelsOnXAxis, numberOfLabelsOnYAxis, fontSettings, colorSettings, ctx, axisTitles, xAxisLabels);
    ...
    verifyParameterTypes(canvasProperties, graphProperties, dataset, maxNumberOfLabelsOnXAxis, numberOfLabelsOnYAxis, fontSettings, colorSettings, ctx, axisTitles, xAxisLabels) {
...
//# sourceMappingURL=GraphAndCanvasData.js.map